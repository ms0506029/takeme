 ...
 * Phase 7.0 (Pro Max) - Bento Grid Layout
 */
export const BeforeDashboard: React.FC = () => {
  ...
  return (
    <div className={baseClass} style={{ fontFamily: 'var(--font-body)', position: 'relative' }}>
      {/* Texture overlay (using class from custom.scss) */}
      <div className="admin-texture" />
      ...
      {isSuperAdmin && (
        <div style={{ padding: '0 1rem', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-text-main)', marginBottom: '0.25rem', fontFamily: 'var(--font-heading)' }}>
          ...
          <div style={{ 
            ...
            >
              <div style={{ textAlign: 'center', color: 'var(--color-text-sub)' }}>
                ...
                <p style={{ fontWeight: 600, color: 'var(--color-text-main)' }}>銷售分析報表</p>
